      ...
      {events.map((event, index) => (
        ...
        >
          ...
          <div className="relative flex items-start gap-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 transition-all group-hover:bg-gray-900 group-hover:text-white">
            ...
            <div className="flex-1">
              ...
              <div className="mb-2">
                <code className="text-xs font-mono text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 px-2 py-1 rounded-md">
                  {event.detail}
                </code>
              </div>
