    ...
    <div className="max-w-4xl">
      ...
      <section id="hydration-import" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-2">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Hydration Import Order</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">The first import in any client-side entry point</p>
          </div>
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-700 dark:text-gray-300">Why first?</span>{' '}
      ...
      <section id="nextjs" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-3">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Next.js Setup</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">App Router with 'use client' components</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 dark:from-gray-700 to-transparent" />
        </div>
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-start gap-3">
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-xs font-bold">1</div>
            <div>
              <p className="text-gray-700 dark:text-gray-300 font-medium">Install packages</p>
              <CodeBlock code="npm install @lit-ui/core @lit-ui/button @lit-ui/ssr" language="bash" />
            </div>
          </div>

          <div className="flex items-start gap-3">
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-xs font-bold">2</div>
            <div>
        ...
        <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-700 dark:text-gray-300">Why 'use client'?</span>{' '}
      ...
      <section id="astro" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-4">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Astro Setup</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Frontmatter imports for SSR, script tag for hydration</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 dark:from-gray-700 to-transparent" />
        </div>
        ...
        <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-700 dark:text-gray-300">Two imports?</span>{' '}
      ...
      <section id="fouc" className="scroll-mt-20 mb-14 animate-fade-in-up opacity-0 stagger-5">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">FOUC Prevention</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400">Hide components until defined</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 dark:from-gray-700 to-transparent" />
        </div>
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-700 dark:text-gray-300">Quick option:</span>{' '}
            Import the pre-built CSS: <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">@import '@lit-ui/core/fouc.css';</code>
          </p>
        </div>
      </section>
