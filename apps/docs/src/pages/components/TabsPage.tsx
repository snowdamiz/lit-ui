...
const tabsCSSVars: CSSVarDef[] = [
  { name: '--ui-tabs-border', default: 'var(--color-border)', description: 'Border color.' },
  { name: '--ui-tabs-list-bg', default: 'var(--color-muted)', description: 'Tab list background.' },
  ...
  { name: '--ui-tabs-tab-text', default: 'var(--color-muted-foreground)', description: 'Inactive tab text color.' },
  { name: '--ui-tabs-tab-bg', default: 'transparent', description: 'Inactive tab background.' },
  { name: '--ui-tabs-tab-hover-text', default: 'var(--color-foreground)', description: 'Hover tab text color.' },
  { name: '--ui-tabs-tab-hover-bg', default: 'transparent', description: 'Hover tab background.' },
  { name: '--ui-tabs-tab-active-text', default: 'var(--color-foreground)', description: 'Active tab text color.' },
  { name: '--ui-tabs-tab-active-bg', default: 'var(--color-background)', description: 'Active tab background.' },
  ...
  { name: '--ui-tabs-panel-text', default: 'var(--color-foreground)', description: 'Panel text color.' },
  { name: '--ui-tabs-ring', default: 'var(--color-ring)', description: 'Focus ring color.' },
  { name: '--ui-tabs-transition', default: '150ms', description: 'Transition duration.' },
  { name: '--ui-tabs-indicator-color', default: 'var(--color-primary)', description: 'Sliding indicator color.' },
