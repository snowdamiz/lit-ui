...
const dataTableCSSVars: CSSVarDef[] = [
  { name: '--ui-data-table-header-bg', default: 'var(--color-muted, #f4f4f5)', description: 'Header row background color.' },
  { name: '--ui-data-table-row-bg', default: 'var(--color-background, #ffffff)', description: 'Data row background color.' },
  { name: '--ui-data-table-row-hover-bg', default: 'var(--color-muted, #f4f4f5)', description: 'Data row background on hover.' },
  { name: '--ui-data-table-border-color', default: 'var(--color-border, #e4e4e7)', description: 'Border color for table, rows, and cells.' },
  { name: '--ui-data-table-text-color', default: 'var(--color-foreground, #09090b)', description: 'Primary text color for cell content.' },
  { name: '--ui-data-table-header-text', default: 'var(--color-muted-foreground, #71717a)', description: 'Header cell text color.' },
  ...
  { name: '--ui-data-table-selected-bg', default: 'rgba(59, 130, 246, 0.1)', description: 'Background color for selected rows.' },
  { name: '--ui-data-table-selected-hover-bg', default: 'rgba(59, 130, 246, 0.15)', description: 'Selected row background on hover.' },
  { name: '--ui-data-table-banner-bg', default: '#eff6ff', description: 'Selection banner / bulk actions toolbar background.' },
  { name: '--ui-data-table-overlay-bg', default: 'rgba(255, 255, 255, 0.7)', description: 'Background overlay during "updating" loading state.' },
  { name: '--ui-data-table-skeleton-base', default: '#e4e4e7', description: 'Skeleton loading animation base color.' },
  { name: '--ui-data-table-skeleton-highlight', default: '#f4f4f5', description: 'Skeleton loading animation highlight color.' },
];
