    ...
    <div className="max-w-4xl">
      ...
      <section id="npm-installation" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-2">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Recommended for most projects</p>
          </div>
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-100">
          <p className="text-sm text-gray-600">
            ...
            Replace <code className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-xs font-mono">npm install</code> with{' '}
            <code className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-xs font-mono">yarn add</code> or{' '}
            <code className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-xs font-mono">pnpm add</code>.
          </p>
        </div>
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-100">
          <p className="text-sm text-gray-600">
            <span className="font-medium text-gray-700">Web components work everywhere.</span>{' '}
            Use <code className="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-xs font-mono">lui-button</code> directly in React, Vue, Svelte, Angular, or plain HTML.
          </p>
        </div>
      </section>
      ...
      <section id="copy-source" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-3">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Copy-Source Installation</h2>
            <p className="text-sm text-gray-500">Own and customize the source code</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 to-transparent" />
        </div>
        ...
        <p className="text-gray-600 mt-6">
          ...
          <Link to="/getting-started" className="text-gray-900 font-medium underline decoration-gray-300 underline-offset-2 hover:decoration-gray-900 transition-colors">
      ...
      <section id="choosing" className="scroll-mt-20 mb-14 animate-fade-in-up opacity-0 stagger-4">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Choosing Your Approach</h2>
            <p className="text-sm text-gray-500">Trade-offs to consider</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 to-transparent" />
        </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-semibold text-gray-900">NPM Packages</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-900">Copy-Source</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 bg-white">
              <tr>
                <td className="px-4 py-3 font-medium text-gray-700">Updates</td>
                <td className="px-4 py-3 text-gray-600">Automatic via npm update</td>
                <td className="px-4 py-3 text-gray-600">Manual (run migrate command)</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium text-gray-700">Customization</td>
                <td className="px-4 py-3 text-gray-600">CSS variables only</td>
                <td className="px-4 py-3 text-gray-600">Full source access</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium text-gray-700">Bundle size</td>
                <td className="px-4 py-3 text-gray-600">Tree-shakeable</td>
                <td className="px-4 py-3 text-gray-600">Only what you copy</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium text-gray-700">Best for</td>
                <td className="px-4 py-3 text-gray-600">Standard usage, staying up-to-date</td>
                <td className="px-4 py-3 text-gray-600">Deep customization, code ownership</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-100">
          <p className="text-sm text-gray-600">
            <span className="font-medium text-gray-700">Start with npm packages.</span>{' '}
