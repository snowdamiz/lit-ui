    ...
    <div className="max-w-4xl">
      ...
      <section id="when-to-migrate" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-2">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">When to Migrate</h2>
            <p className="text-sm text-gray-500">Decide if migration is right for you</p>
          </div>
        ...
        <div className="p-4 rounded-xl bg-gray-50 border border-gray-100">
          <p className="text-sm text-gray-600">
            <span className="font-medium text-gray-700">Keep copy-source</span>{' '}
      ...
      <section id="run-migration" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-3">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Run the Migration</h2>
            <p className="text-sm text-gray-500">One command to convert your project</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 to-transparent" />
        </div>
        ...
        <div className="mt-8 space-y-3">
          <p className="text-sm font-medium text-gray-700">The migration command will:</p>
      ...
      <section id="update-imports" className="scroll-mt-20 mb-16 animate-fade-in-up opacity-0 stagger-4">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Update Your Imports</h2>
            <p className="text-sm text-gray-500">Change local paths to npm packages</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 to-transparent" />
        </div>
      ...
      <section id="modified-files" className="scroll-mt-20 mb-14 animate-fade-in-up opacity-0 stagger-5">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Modified Files</h2>
            <p className="text-sm text-gray-500">Handling customized components</p>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-gray-200 to-transparent" />
        </div>
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-xl border border-gray-200 bg-white">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-gray-700">Component modified</span>
            </div>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-4 rounded-xl border border-gray-200 bg-white">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.action} className="flex items-start gap-2 text-sm text-gray-600">
                  <span className="font-medium text-gray-700 w-16 flex-shrink-0">{item.action}:</span>
                  <span>{item.desc}</span>
                </li>
              ))}
            </ul>
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-100">
          <p className="text-sm text-gray-600">
            <span className="font-medium text-gray-700">Mixed mode:</span>{' '}
