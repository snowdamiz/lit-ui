...
function TreemapChartDemo() {
  ...
  return <lui-treemap-chart ref={ref as any} breadcrumb style={{ height: '300px', display: 'block' }} />;
}

const treemapChartProps: PropDef[] = [
  {
    name: 'data',
    type: 'TreemapNode[] | undefined',
    default: 'undefined',
    description: 'Hierarchical tree data as an array of TreemapNode objects. Each node has { name: string, value: number, children?: TreemapNode[] }. JS property only — cannot be set via HTML attribute.',
  },
  {
    name: 'option',
  ...
  },
  {
    ...
    type: 'boolean',
    default: 'true',
    description: 'Show a breadcrumb trail for navigating drill-down levels.',
  },
  {
    name: 'rounded',
    type: 'boolean',
    default: 'false',
    description: 'Apply rounded corners to treemap tiles. Corner radius decreases at deeper levels.',
  },
  {
    name: 'level-colors',
    type: 'string[][] | null',
    default: 'null',
    description: 'Per-level color arrays. Each inner array specifies colors for that depth level (e.g. [[\'#6366f1\',\'#8b5cf6\'],[\'#a78bfa\',\'#c4b5fd\']]). null uses the default ThemeBridge palette.',
  },
];
    ...
    <FrameworkProvider>
      <div className="max-w-4xl">
        ...
        <header className="relative mb-10 animate-fade-in-up opacity-0 stagger-1">
          ...
          <div className="relative">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed max-w-2xl">
              Hierarchical treemap with space-filling layout, breadcrumb navigation, and per-level colors.
            </p>
          </div>
        </header>
        ...
        <div className="mb-8 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-sm text-blue-800 dark:text-blue-200">
          <strong>Tree-shaking tip:</strong> Import <code>@lit-ui/charts/treemap-chart</code> (subpath) instead of <code>@lit-ui/charts</code> to include only this chart's modules (~135KB gzipped vs 350KB+ for all charts).
        </div>
        ...
        <div className="space-y-12 animate-fade-in-up opacity-0 stagger-2">
          ...
          {/* Live demo */}
          <section>
            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">Product Category Treemap</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm">
              Hierarchical treemap with 2 root nodes each containing 2 children. Click a tile to drill down. Data is set via the <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">.data</code> JavaScript property.
            </p>
            <ExampleBlock
        ...
        <section className="mt-20 mb-14 animate-fade-in-up opacity-0 stagger-3">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="px-2.5 py-1 rounded-full bg-gray-900 dark:bg-gray-100 text-xs font-bold text-white dark:text-gray-900">{treemapChartProps.length}</span>
            </div>
            <PropsTable props={treemapChartProps} />
          </div>
