...
const areaChartProps: PropDef[] = [
  ...
  },
  {
    ...
    type: 'number',
    default: '500000',
    description: 'Maximum streaming buffer points. Area chart overrides base default from 1000 to 500,000 — at 1000 pts/sec this allows ~8 minutes before auto reset.',
  },
  {
    name: 'smooth',
    type: 'boolean',
