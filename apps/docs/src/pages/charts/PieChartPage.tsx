...
const pieChartProps: PropDef[] = [
  {
    name: 'data',
    type: '{ name: string; value: number }[] | undefined',
    default: 'undefined',
    description: 'Chart data as an array of name/value pairs. JS property only — cannot be set via HTML attribute.',
  },
  {
    name: 'option',
  ...
  },
  {
    ...
    type: 'number',
    default: '0',
    description: 'Minimum percentage threshold for displaying a slice. Slices below this value are merged.',
  },
  {
    name: 'inner-radius',
    type: 'string | number',
    default: "''",
    description: "Inner radius for donut mode (e.g. '40%' or 80). Empty string disables donut mode.",
  },
  {
    name: 'center-label',
    type: 'string',
    ...
    <FrameworkProvider>
      <div className="max-w-4xl">
        ...
        <header className="relative mb-10 animate-fade-in-up opacity-0 stagger-1">
          ...
          <div className="relative">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed max-w-2xl">
              Pie and donut chart with configurable slice merging, inner radius for donut mode, and a center label for totals.
            </p>
          </div>
        </header>
        ...
        <div className="mb-8 p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-sm text-blue-800 dark:text-blue-200">
          <strong>Tree-shaking tip:</strong> Import <code>@lit-ui/charts/pie-chart</code> (subpath) instead of <code>@lit-ui/charts</code> to include only this chart's modules (~135KB gzipped vs 350KB+ for all charts).
        </div>
        ...
        <div className="space-y-12 animate-fade-in-up opacity-0 stagger-2">
          ...
          {/* Live demo */}
          <section>
            <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">Donut Chart with Center Label</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm">
              Donut-style pie chart with <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">inner-radius="40%"</code> and a center label. Set <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">inner-radius</code> to an empty string for a standard pie chart. Data is set via the <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">.data</code> JavaScript property.
            </p>
            <ExampleBlock
        ...
        <section className="mt-20 mb-14 animate-fade-in-up opacity-0 stagger-3">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="px-2.5 py-1 rounded-full bg-gray-900 dark:bg-gray-100 text-xs font-bold text-white dark:text-gray-900">{pieChartProps.length}</span>
            </div>
