        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex items-center gap-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 transition-all hover:-translate-y-0.5 hover:border-transparent hover:bg-gray-900 dark:hover:bg-gray-100 hover:text-white dark:hover:text-gray-900 focus-ring"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#features" className="relative text-sm text-gray-500 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-100 after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-gray-400 dark:after:bg-gray-500 after:transition-all after:duration-300 hover:after:w-full">
                  Features
                </a>
              </li>
              <li>
                <a href="#components" className="relative text-sm text-gray-500 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-100 after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-gray-400 dark:after:bg-gray-500 after:transition-all after:duration-300 hover:after:w-full">
                  Components
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="relative text-sm text-gray-500 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-100 after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-gray-400 dark:after:bg-gray-500 after:transition-all after:duration-300 hover:after:w-full">
                  Changelog
                </a>
              </li>
            </ul>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="relative text-sm text-gray-500 dark:text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-100 after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-gray-400 dark:after:bg-gray-500 after:transition-all after:duration-300 hover:after:w-full"
                >
                  Lit
                </a>
              </li>
