...
function FrameworkLogos() {
  ...
  return (
    <section className="relative py-20 md:py-24">
      {/* Soft gradient overlaps */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-16 section-fade-top" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 section-fade-bottom" />
