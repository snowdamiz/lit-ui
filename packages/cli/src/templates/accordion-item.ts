/**
 * AccordionItem component template
 */
export const ACCORDION_ITEM_TEMPLATE = `/**
...
export class AccordionItem extends TailwindElement {
  ...
  static override styles = [
    ...
    css\`
      :host {
        display: block;
        border-bottom: var(--ui-accordion-border-width, 1px) solid
          var(--ui-accordion-border, #e5e7eb);
      }
