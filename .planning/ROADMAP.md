...
- ✅ **v9.0 Charts System** - Phases 88-96 (shipped 2026-03-01)
...
- [x] 096-04-PLAN.md — Docs pages (wave 2): ScatterChartPage, HeatmapChartPage, CandlestickChartPage, TreemapChartPage + App.tsx routes + nav.ts Charts section
