...
- [ ] **BTN-02**: Button docs page is accurate and up-to-date
- [ ] **BTN-03**: `skill/skills/button` skill file is accurate and up-to-date
...
- [ ] **INP-01**: Input default styles match the v8.0 monochrome theme
- [ ] **INP-02**: Input docs page is accurate and up-to-date
...
- [ ] **TXT-02**: Textarea docs page is accurate and up-to-date
- [ ] **TXT-03**: `skill/skills/textarea` skill file is accurate and up-to-date

### Select

- [ ] **SEL-01**: Select default styles match the v8.0 monochrome theme
