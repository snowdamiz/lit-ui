...
Plans:
- [x] 87-01-PLAN.md — Remove cascadeable data-table dark mode tokens from .dark block; keep oklch and value-inversion exceptions (DAT-01)
- [x] 87-02-PLAN.md — Replace dataTableCSSVars with 35-entry accurate array matching tailwind.css :root (DAT-02)
- [x] 87-03-PLAN.md — Update skill/skills/data-table/SKILL.md CSS tokens and add Behavior Notes (DAT-03)
