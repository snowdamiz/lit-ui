...
Plans:
- [x] 97-01-PLAN.md — Update skill/SKILL.md main router + create skill/skills/charts/SKILL.md overview
- [x] 97-02-PLAN.md — Create line-chart, area-chart, bar-chart sub-skills
- [x] 97-03-PLAN.md — Create pie-chart, scatter-chart, heatmap-chart sub-skills
- [x] 97-04-PLAN.md — Create candlestick-chart, treemap-chart sub-skills
