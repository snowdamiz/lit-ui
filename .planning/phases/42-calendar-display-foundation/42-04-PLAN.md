...
<task type="auto">
  ...
  <action>
    ...
    6. **Do NOT set tabindex in the Lit template.** Remove any tabindex attributes from the date-button template. Tabindex is managed entirely by KeyboardNavigationManager in lifecycle hooks.
  ...
  <verify>
    ...
    - No `tabindex` attribute in Lit template html`` strings (except aria attributes)
