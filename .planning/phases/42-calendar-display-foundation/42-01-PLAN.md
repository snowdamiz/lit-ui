...
<task type="auto">
  ...
  <verify>
    ...
    - `grep 'import.*from.*date-fns' packages/calendar/src/date-utils.ts` confirms date-fns integration works (startOfMonth, endOfMonth, etc. imported)
